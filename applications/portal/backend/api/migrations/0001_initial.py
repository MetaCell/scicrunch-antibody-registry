# Generated by Django 4.0.6 on 2022-10-05 13:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat_alt', models.CharField(db_index=True, max_length=512, null=True)),
                ('url', models.URLField(db_index=True, max_length=2048, null=True)),
                ('subregion', models.CharField(db_column='target_subregion', db_index=True, max_length=256, null=True)),
                ('modifications', models.CharField(db_column='target_modification', db_index=True, max_length=128, null=True)),
                ('epitope', models.CharField(db_index=True, max_length=1024, null=True)),
                ...
                ('clone_id', models.CharField(db_index=True, max_length=256, null=True)),
                ('product_isotype', models.CharField(db_index=True, max_length=256, null=True)),
                ('product_conjugate', models.CharField(db_index=True, max_length=512, null=True)),
                ('defining_citation', models.CharField(max_length=16384, null=True)),
                ('product_form', models.CharField(db_index=True, max_length=1024, null=True)),
                ('comments', models.TextField(null=True)),
                ('kit_contents', models.TextField(db_index=True, null=True)),
                ('feedback', models.TextField(db_index=True, null=True)),
                ('curator_comment', models.TextField(db_index=True, null=True)),
                ('disc_date', models.CharField(db_index=True, max_length=128, null=True)),
        ...
        migrations.AddField(
            ...
            name='antibody',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.antibody'),
        ),
        migrations.AddField(
            model_name='antibodyspecies',
            name='specie',
