export const faqsInfo = [
  ...
  },
  {
    ...
    answer: "An antibody that is already registered does not need to be registered again. Sometimes a user submits a duplicate that has recently been registered and does not yet appear in the public record, this will result in a system message that states that it is a duplicate. Be assured that the curator will look at all submissions and get back to you in 1 business day (excluding major US holidays)."
  },
  {
    question: "How do I edit my own submissions? (must be logged in)",
    ansswer: "If you have made an error in your submission, you can click on the 'Edit my submissions' button to make changes."
  },
  {
    question: "How can I download data?",
    answer: "Humans: Selecting a handful of antibodies and downloading the list is accomplished by clicking the box icon on the left of each antibody. Humans Bulk: Downloading all data in bulk requires that you are logged into the AntibodyRegistry. A new tab opens called “Download”. The following information is provided: We are now providing a full csv of the more important data for the Antibody Registry. The CSV is rather large, and contains 6 columns (our ID, AB Name, Vendor, Catalog Number, Citation, and Reference). This file is updated weekly on Friday night (Pacific time)."
  },
  {
  ...
  },
  {
    ...
    answer: "The Antibody Registry was created as part of the Neuroscience Information Framework (DA039832) and created at the University of California at San Diego by Drs. Vadim Astakhov and Anita Bandrowski. Mr Davis Banks moved the Antibody Registry in 2014 to a MySQL database from ORACLE. Mr. Joseph Menke, Mr. Mason Pairish both served as the most recent curators for the registry.Formal governance was not established until the funding of the STTR award GM131551, under which responsibility and oversight of the registry was transferred to SciCrunch Inc. The current development team is MetaCell Inc. Under the GM144308 award the Antibody Registry will become a part of the RRIDs.org non-for-profit organization with an advisory board."
  },
  {
    question: "Who are stakeholders in the antibody registry?",
    ansswer: "The major groups that the Antibody Registry brings together include antibody companies (~300 are registered & see list of partners on the About page), researchers (>10,000 registered users), and publishers (>2000 journals contain at least one paper with at least one antibody RRID). However the problem of identifying antibodies in the scientific literature spans most of biomedicine and some of chemistry, thus nearly all biomedical researchers should be stakeholders and advocate for better antibody reagent identification."
  },
  {
    question: "How do I get information about your API / Programmatic access?",
    answer: "The Antibody Registry does not provide direct API access to the database. We utilize the work of our colleagues at the FDI Lab to provide this access to an index of the antibody data. Please go to https://scicrunch.org > MyAccount > API to gain access."
  },
  {
    question: "Do you have sustainability and preservation policy?",
    answer: "The Antibody Registry is maintained with public support from the NIH and membership fees of partner companies. Transfer of the database to a non-for-profit organization, stipulated as part of the GM144308 award, will ensure longer term stability. However if all else fails, the data licensed at CC-0 will be archived in Zenodo, the University of California San Diego Data Repository, and the California Digital Library. Current data are stored within Amazon S3, part of Amazon Web Services (AWS) designed to provide 99.9% durability of object over a given year/years; automated database backups happen every day in a relevant AWS S3 bucket; Data is permanently archived in a third party archival system to ensure long term data preservation. Certification of CoreTrustSeal will be sought under the GM144308 funding mechanism."
  },
  {
  ...
  },
  {
    ...
    answer: "Antibody data can be downloaded as a CSV file (see instructions above) and accessed via the scicrunch API (see instructions above) in json and xml format. Each record in the RRID resolver is also available without login as json and xml by simply adding the .json or .xml suffix to the URL. Example: https://scicrunch.org/RRID:AB_90755.json"
  },
  {
    question: "What is the licence of the antibody registry?",
    answer: "RRIDs are freely available for reuse under the CC-0 License, including several metadata fields (vendor name, catalog number, proper citation) are available to reuse at any time for any purpose. Metadata granted to the Antibody Registry from the antibody companies that enables better search is freely available to search and use, but with important limitations for commercial reuse, as it is covered under the CC-NC license. Please contact abr-help -at- scicrunch -dot- org to discuss."
  },
  {
    question: "What is the antibody data to paper relationship?",
    answer: "Some antibodies are used in scientific papers, and where authors list the RRID they used, if the submitter specifies the paper where origination of the antibody was described, or curators discover and annotate the RRID in the paper, there is a link between the antibody records and a PubMed identifier (paper). Note to authors, it may take a month or more for your paper to show up as associated with your registered antibody. The delay is sometimes that closed access publications delay our curation. If your manuscript has been out for ~6 months or is in the open access literature but you do not see it associated with your antibody, please contact us (abr-help -at- scicrunch -dot- org)."
  },
  {
  ...
  },
  {
    ...
    answer: "We are proud to support the Research Resource Identification, RRID, Initiative as the antibody authority. Every antibody listed in the Antibody Registry is also listed in the RRID portal. Every antibody is also accessible via several resolving services including the RRID resolver (example)."
  },
  {
