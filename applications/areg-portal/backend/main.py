...
#   timestamp: 2022-09-21T14:27:58+00:00
...
def get_antibody(antibody_id: int = Path(..., alias='antibody_id')) -> Antibody:
    """
    Get a Antibody
    """
...
def update_antibody(
    antibody_id: int = Path(..., alias='antibodyId'), body: AddUpdateAntibody = ...
) -> None:
    """
    Update a Antibody
    """
...
def delete_antibody(antibody_id: int = Path(..., alias='antibodyId')) -> None:
    """
    Delete a Antibody
    """
