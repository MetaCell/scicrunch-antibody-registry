...
@prefix_router.get('/antibodies', response_model=List[Antibody], tags=['antibody'])
def get_antibodies(
...
@prefix_router.get('/antibodies/search', response_model=List[Antibody], tags=['search'])
def fts_antibodies(
