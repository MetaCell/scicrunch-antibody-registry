# Generated by Django 4.0.6 on 2022-09-21 13:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ab_name', models.CharField(max_length=512, null=True)),
                ...
                ('catalog_num', models.CharField(max_length=64, null=True)),
                ('cat_alt', models.CharField(max_length=256, null=True)),
                ('url', models.URLField(max_length=2048, null=True)),
                ('subregion', models.CharField(db_column='target_subregion', max_length=32, null=True)),
                ('modifications', models.CharField(db_column='target_modification', max_length=64, null=True)),
                ('epitope', models.CharField(max_length=128, null=True)),
                ...
                ('product_conjugate', models.CharField(max_length=128, null=True)),
                ('defining_citation', models.CharField(max_length=2048, null=True)),
                ('product_form', models.CharField(max_length=512, null=True)),
                ...
                ('disc_date', models.CharField(max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symbol', models.CharField(db_column='ab_target', max_length=512, null=True)),
                ('entrez_id', models.CharField(db_column='ab_target_entrez_gid', max_length=1024, null=True)),
        ...
        migrations.AddField(
            model_name='antibody',
            name='antigen',
            field=models.ForeignKey(db_column='antigen_id', on_delete=django.db.models.deletion.RESTRICT, to='api.gene'),
        ),
        migrations.AddField(
            model_name='antibody',
